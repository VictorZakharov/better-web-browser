...
[void] $markdown.AppendLine()
[void] $markdown.AppendLine('- `boa_engine` is a locally modified path dependency from Boa revision `bc36c3fac0969ea21ea0570b62e7846f97389b73`, offered under Unlicense OR MIT. Changes are recorded in `vendor/boa_engine/LOCAL_CHANGES.md`; both upstream license texts are preserved beside the source and copied into release archives.')
