        ...
        try {
            ...
            if ($path -eq '/iframe-initial') {
                ...
                if ($q) {
                    ...
                    $html += '<script>document.querySelector("a").onclick=e=>{e.preventDefault();const a=document.createElement("a");a.href="/destination";a.click()};</script>'
                } else {
            ...
            $html = '<!doctype html><meta charset="utf-8"><title>Form navigation fixture</title><style>body{margin:20px;font:16px Arial}#start{width:100px;height:40px}form{margin-top:20px}</style>' + $html
