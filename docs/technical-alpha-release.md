...
- Platform coverage is incomplete. User-visible non-DRM H.264/AAC MP4 playback, bounded Media Source input, synchronized audio, controls, and fullscreen are implemented through the contained media worker. Other codecs and containers, encrypted media, captions, track selection, picture-in-picture, canvas, downloads, extensions, and cross-site frame isolation remain incomplete; many broader WPT areas fail.
