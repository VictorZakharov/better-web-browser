...
- Platform coverage is incomplete. Canvas, audio/video playback, downloads, accessibility integration, extensions, and cross-site frame isolation are not implemented; many broader WPT areas fail.
