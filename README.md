...
| ◩ | IndexedDB | Browser-owned origin-scoped databases provide asynchronous object-store transactions, ordered keys/ranges/cursors, structured-cloned values, and restart persistence. Indexes, worker exposure, and full cross-tab scheduling remain incomplete; see the [standards slice](docs/html5test-websocket-indexeddb-forms.md). |
