...
- Native text/search/password/select controls and buttons with renderer-owned state and trusted events, plus [bounded GET/POST form submission](docs/form-submission-and-navigation.md), [constraint validation with native feedback](docs/form-control-validation.md), submitter/validation events, and synthetic link activation
