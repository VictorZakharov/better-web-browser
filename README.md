...
| ◩ | Canvas, media, and downloads | HTML media objects and video replaced-element layout exist, and the restricted media worker decodes a bounded, acknowledged sequence of advancing H.264/AAC fixture frames. Timed page presentation, audio output, seeking, MSE, user-visible playback, canvas, and downloads are not yet implemented; codec APIs therefore remain fail-closed. |
