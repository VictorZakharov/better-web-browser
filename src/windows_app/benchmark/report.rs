//! Benchmark completion, measurement aggregation, and artifact serialization.
use super::*;
    ...
    pub(in crate::windows_app) unsafe fn finish_benchmark(&mut self) {
        ...
        let json = format!(
            concat!(
                ...
                "  \"font_catalog_ms\": {:.3},\n",
                "  \"font_select_ms\": {:.3},\n",
                "  \"open_type_shape_ms\": {:.3},\n",
                "  \"glyph_raster_ms\": {:.3},\n",
                "  \"presentation_encode_ms\": {:.3},\n",
                "  \"presentation_decode_ms\": {:.3},\n",
                "  \"presentation_install_ms\": {:.3},\n",
                "  \"paint_ms\": {:.3},\n",
            ...
            navigation_ms,
            if self.navigation.network_pending() {
                "null".into()
            } else {
                format!("{:.3}", benchmark.network_time.as_secs_f64() * 1_000.0)
            },
            ...
            benchmark.font_catalog_time.as_secs_f64() * 1_000.0,
            benchmark.font_select_time.as_secs_f64() * 1_000.0,
            benchmark.open_type_shape_time.as_secs_f64() * 1_000.0,
            benchmark.glyph_raster_time.as_secs_f64() * 1_000.0,
            benchmark.presentation_encode_time.as_secs_f64() * 1_000.0,
            benchmark.presentation_decode_time.as_secs_f64() * 1_000.0,
            benchmark.presentation_install_time.as_secs_f64() * 1_000.0,
