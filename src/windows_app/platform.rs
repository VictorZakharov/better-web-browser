...
pub(super) const WM_ACTIVATE: u32 = 0x0006;
...
pub(super) const WM_APP_BENCHMARK_FILMSTRIP: u32 = WM_APP + 17;
...
pub(super) const VK_SPACE: usize = 0x20;
pub(super) const VK_LEFT: usize = 0x25;
...
pub(super) const BN_CLICKED: usize = 0;
