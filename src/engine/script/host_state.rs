...
pub(super) struct HostState {
    ...
    pub(super) form_plans: super::host_call::navigation::FormPlans,
    pub(super) user_input_active: bool,
    ...
    pub(super) document_streams: super::document_streams::DocumentStreams,
    pub(super) pending_dynamic_scripts: super::dynamic_scripts::queue::ScriptQueue,
    pub(super) module_jobs: super::dynamic_modules::ModuleJobs,
    ...
    pub(super) pending_websocket_actions: Vec<super::network::ScriptWebSocketAction>,
    pub(super) pending_database_actions: Vec<super::network::ScriptDatabaseAction>,
    ...
    pub(super) pending_pointer_lock_actions: Vec<ScriptPointerLockAction>,
    ...
    pub(super) hit_test_snapshot: crate::engine::layout::HitTestSnapshot,
    pub(super) hit_test_geometry_version: Option<u64>,
    ...
    pub(super) intersection_observers_pending: bool,
    pub(super) intersection_task_pending: bool,
...
impl HostState {
    pub(super) fn new(
        ...
        let mut state = Self {
            ...
            pending_websocket_actions: Vec::new(),
            pending_database_actions: Vec::new(),
            worker_identifiers: Default::default(),
            pending_worker_actions: Vec::new(),
            pending_fullscreen_actions: Vec::new(),
            pending_pointer_lock_actions: Vec::new(),
            ...
            hit_test_geometry_version: None,
            ...
            intersection_observers_pending: false,
            intersection_task_pending: false,
