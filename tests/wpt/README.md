...
After the fixtures exist, all 24 curated cases run with one offline command:
...
the command fail. This forces the manifest to be updated deliberately when compatibility changes.
